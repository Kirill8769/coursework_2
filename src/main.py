...
def play_game(basic_word: BasicWord):
    ...
    print(f'Программа: Слова должны быть не короче 3 букв')
    print(f'Программа: Чтобы закончить игру, угадайте все слова или напишите "stop"')
    print('---')
    print(f'Программа: Поехали, ваше первое слово?')
